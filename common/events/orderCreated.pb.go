...
type OrderCreated struct {
	...
	Data    *OrderCreated_Data `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *OrderCreated) GetData() *OrderCreated_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *OrderCreated_Data) Reset() {
	*x = OrderCreated_Data{}
	if protoimpl.UnsafeEnabled {
...
func (x *OrderCreated_Data) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderCreated_Data) ProtoMessage() {}

func (x *OrderCreated_Data) ProtoReflect() protoreflect.Message {
	mi := &file_orderCreated_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderCreated_Data.ProtoReflect.Descriptor instead.
func (*OrderCreated_Data) Descriptor() ([]byte, []int) {
	return file_orderCreated_proto_rawDescGZIP(), []int{0, 0}
}

func (x *OrderCreated_Data) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *OrderCreated_Data) GetStatus() Status {
	if x != nil {
		return x.Status
	}
...
func (x *OrderCreated_Data) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *OrderCreated_Data) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
var file_orderCreated_proto_rawDesc = []byte{
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x01, 0x0a,
	0x0d, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x22,
	...
	0x63, 0x74, 0x12, 0x27, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x8b, 0x01, 0x0a, 0x04,
	...
	0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x61, 0x73, 0x69, 0x6c, 0x6e, 0x73, 0x61,
	0x67, 0x65, 0x2f, 0x6d, 0x77, 0x6e, 0x2d, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x61, 0x70, 0x70,
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06,
...
var file_orderCreated_proto_goTypes = []interface{}{
	(*OrderCreated)(nil),          // 0: order_created
	(*OrderCreated_Data)(nil),     // 1: order_created.Data
	(subjects.Subject)(0),         // 2: Subject
	(Status)(0),                   // 3: Status
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_orderCreated_proto_depIdxs = []int32{
	2, // 0: order_created.subject:type_name -> Subject
	1, // 1: order_created.data:type_name -> order_created.Data
	3, // 2: order_created.Data.status:type_name -> Status
	4, // 3: order_created.Data.expires_at:type_name -> google.protobuf.Timestamp
...
func file_orderCreated_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_orderCreated_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OrderCreated_Data); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
